...
gulp.task('server', ['style:build'], () => {
  ...
  gulp.watch(path.watch.pug, ['html:build'], browserSync.reload);
  gulp.watch(path.watch.sass, ['style:build'], browserSync.reload);
  gulp.watch(path.watch.js, ['js:build'], browserSync.reload);
